...
import TableCustom, { HeaderCol } from '@/components/ui/custom/TableCustom';

const headerTableInit: HeaderCol[] = [
  { display: 'ชื่อหน้า', id: 'name', sort: '', class: 'w-[70px]' },
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Custom Table component with sortable columns, flexible slots, and Tailwind styling.',
      },
    },
  },
  argTypes: {},
        ...
        >
          <div className="cursor-pointer">
            ...
            >
              ...
              />
              <path d="M10 3L14 7" stroke="#343A40" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M9 17H17" stroke="#343A40" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
          <div className="cursor-pointer">
            <svg
            ...
            >
              ...
              <path
                ...
                strokeLinejoin="round"
              />
              <path d="M8 7V13" stroke="#343A40" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M5 10H11" stroke="#343A40" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
          <div className="cursor-pointer">
            <svg
